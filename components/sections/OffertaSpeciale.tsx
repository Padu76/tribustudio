...
const benefits = [
  ...
  'Test iniziali di postura e mobilità',
...
export default function OffertaSpeciale() {
  ...
  return (
    <section
      className="section-padding bg-gradient-to-br from-primary to-primary-dark text-white relative overflow-hidden"
      ref={ref}
    >
      ...
      <div className="container-custom mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-montserrat font-bold mb-6">
            ...
            e inizia il tuo percorso di trasformazione
          </h2>

          <p className="text-xl max-w-3xl mx-auto mb-8 opacity-95">
            Prova l&apos;esperienza completa di Tribù Studio: valutazione iniziale,
            lezione personalizzata e indicazioni pratiche su allenamento e alimentazione.
            Il modo migliore per capire cosa possiamo fare per te, senza impegno e con benefici immediati.
          </p>
        </motion.div>
