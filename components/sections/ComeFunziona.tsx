// components/sections/ComeFunziona.tsx
'use client';
...
export default function ComeFunziona() {
  ...
  const steps = [
    {
      icon: ClipboardCheck,
      title: t("comeFunziona", "step1Title"),
      description: t("comeFunziona", "step1Desc"),
      color: 'bg-blue-500'
    },
    {
      icon: Target,
      title: t("comeFunziona", "step2Title"),
      description: t("comeFunziona", "step2Desc"),
      color: 'bg-green-500'
    },
    {
      icon: Dumbbell,
      title: t("comeFunziona", "step3Title"),
      description: t("comeFunziona", "step3Desc"),
      color: 'bg-primary'
    },
    {
      icon: Heart,
      title: t("comeFunziona", "step4Title"),
      description: t("comeFunziona", "step4Desc"),
      color: 'bg-purple-500'
    },
    {
      icon: Trophy,
      title: t("comeFunziona", "step5Title"),
      description: t("comeFunziona", "step5Desc"),
      color: 'bg-yellow-500'
    }
  ];
